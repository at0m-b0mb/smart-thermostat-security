...
func GenerateDiagnosticReport(report DiagnosticReport) string {
	...
	output += fmt.Sprintf("  Sensor Type: %s\n\n", report.SensorStatus.SensorType) // <--- sensor type added
